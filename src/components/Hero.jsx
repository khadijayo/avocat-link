    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-navy-950">
        <div
          ...
          style={{
            backgroundImage: `
              radial-gradient(circle at 20% 50%, #2d3a8c 0%, transparent 50%),
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 mb-8">
              ...
              <span className="text-white/90 text-sm font-medium">
                Algeria's Premier Legal Platform
              </span>
            </div>
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            ...
            <img
              src="/lawyer-hero.jpg"
              alt="Lawyer"
              className="w-[420px] max-w-full rounded-2xl shadow-2xl border border-white/10 hover:scale-[1.03] transition-transform duration-300"
            />
